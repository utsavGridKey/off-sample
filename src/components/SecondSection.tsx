...
const SecondSection = () => {
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row justify-between items-center gap-6 px-4">
      ...
      <div className="text-container relative flex flex-col items-center justify-center w-full text-center gap-4">
        ...
        {/* CTA Button */}
        <button className="bg-black rounded-lg text-white font-['Poppins'] px-4 py-2 md:px-6 md:py-3 text-sm sm:text-base md:text-lg lg:text-2xl flex items-center justify-center cursor-pointer">
          Let’s Talk
        </button>
      ...
      <img
        ...
        alt=""
        className="doodle-bottom-image absolute bottom-0 left-1/2 -translate-x-1/2 w-1/3"
      />
